...
namespace test2
{
    public class OfficeContexFactory : IDesignTimeDbContextFactory<OfficeContex>
    {
        public OfficeContex CreateDbContext(string[] args)
        {
            ...
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-7GGELFU\\SQLEXPRESS;Initial Catalog=Out_of_Office2;Integrated Security=True;Encrypt=False;Trust Server Certificate=True");
